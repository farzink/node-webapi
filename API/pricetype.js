...
var COLLECTION_NAME = "MDPriceType"
var ROUTE = "PriceType";
var DB;
        ...
        if (err) {
            ...
            collection.insert([model], function(err, result) {
                if (err) {
                    ...
                    console.log('Inserted %d documents into the "pricetypes" collection. The documents inserted with "_id" are:', result.length, result);
                }
